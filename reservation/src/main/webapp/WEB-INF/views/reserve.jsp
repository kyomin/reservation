...
<div id="container">
            ...
            <div class="ct_wrap">
                        ...
                        <ul class="visual_img">
                            <li class="item" style="width: 414px;"> <img alt="" class="img_thumb" src="https://ssl.phinf.net/naverbooking/20170217_264/1487312141947lTddT_JPEG/%B3%D7%C0%CC%B9%F6.jpg?type=ff1242_816"> <span class="img_bg"></span>
                                <div class="preview_txt">
                                    <h2 class="preview_txt_tit" id="_preview_txt_tit"></h2>                          
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="section_store_details">
                    <div class="store_details">
                        ...
                        <p class="dsc">
                        		<!-- 하드 코딩! -->
                            	<span class="hide" id="product_price_type_A">성인(만 19~64세) <span id="product_price_A">0</span>원</span><br>
                            	<span class="hide" id="product_price_type_Y">청소년(만 13~18세) <span id="product_price_Y">0</span>원</span><br> 
                            	<span class="hide" id="product_price_type_B">어린이(만 4~12세) <span id="product_price_B">0</span>원</span><br>
                            	<span class="hide" id="product_price_type_S">세트(2인 관람권) <span id="product_price_S">0</span>원</span>
                            	<span class="hide" id="product_price_type_R">R석 <span id="product_price_R">0</span>원</span><br>
                        </p>
                    </div>
                </div>
                <div class="section_booking_ticket">
                    <div class="ticket_body" id="_ticket_body">
                        <!-- 티켓 수량 선택을 위한 리스트가 뿌려진다. -->
                    </div>
                </div>
                <div class="section_booking_form">
                    <div class="booking_form_wrap">
                        <div class="form_wrap">
                            ...
                            <form class="form_horizontal">
                                ...
                                <p style="color:red; padding-left:95px; font-size:10px" class="hide" id="phone_validation">* 000-0000-0000 형식을 지켜주세요!</p>
                                <!-- 이메일 -->
                                <div class="inline_form"> 
                                ...
                                <div class="inline_form last"> 
                                    ...
                                    <div class="inline_control">
                                        <p class="inline_txt selected">
                                        	<span id="reservationDate">2017.2.17</span>, 
                    ...
                    <div class="section_booking_agreement">
                        ...
                        <div class="agreement" id="agreement_1" onClick="handleAgreement(1);"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 수집 및 이용 동의</span> </span>
                            <a class="btn_agreement"> <span class="btn_text" id="btn_text_1">보기</span> <i class="fn fn-down2" id="fn_1"></i> </a>
                        ...
                        <!-- [D] 약관 보기 클릭 시 agreement에 open 클래스 추가 -->
                        <div class="agreement" id="agreement_2" onClick="handleAgreement(2);"> <span class="chk_txt_span"> <i class="spr_book ico_arr_ipc2"></i> <span>개인정보 제3자 제공 동의</span> </span>
                            <a class="btn_agreement"> <span class="btn_text" id="btn_text_2">보기</span> <i class="fn fn-down2" id="fn_2"></i> </a>
                ...
                <div class="box_bk_btn">
                    ...
                    <div class="bk_btn_wrap disable" id="_bk_btn_wrap"> 
                    	<button type="button" class="bk_btn" onClick="javascript:handleSubmit();"> 
    ...
    <!-- 티켓 수 선택 리스트를 위한 템플릿  -->
	<script type="rv-template" id="ticketInfoItem">
		<div class="qty" id="produce_price_{{productPriceId}}">
        	<div class="count_control">
            	<!-- [D] 수량이 최소 값이 일때 ico_minus3, count_control_input에 disabled 각각 추가, 수량이 최대 값일 때는 ico_plus3에 disabled 추가 -->
            	<div class="clearfix">
                	<a class="btn_plus_minus spr_book2 ico_minus3 disabled" id="minus_btn_{{productPriceId}}" title="빼기" onClick="handleTicketMinus({{productPriceId}});"></a> 
					<input type="tel" class="count_control_input disabled" id="count_control_input_{{productPriceId}}" value="0" readonly title="수량">
                    <a class="btn_plus_minus spr_book2 ico_plus3" title="더하기" id="plus_btn" onClick="handleTicketPlus({{productPriceId}});"></a>
                </div>
                
                <!-- [D] 금액이 0 이상이면 individual_price에 on_color 추가 -->
                <div class="individual_price"><span class="total_price" id="total_price_{{productPriceId}}">0</span><span class="price_type">원</span></div>
            </div>
                            
			<div class="qty_info_icon"> 
				<strong class="product_amount"> <span id="price_type_name_{{priceTypeName}}">성인</span> </strong> 
	...
	<script type="text/javascript" src="static/script/reserve/reserve.js"></script>
	<script type="text/javascript" src="static/script/reserve/display_info.js"></script>
	<script type="text/javascript" src="static/script/reserve/product_prices.js"></script>
</body>
</html>